...
static __global__ void flash_attn_ext_f16(
    ...
    while (kbc < kbc_stop && kb0_stop == iter_k) {
        ...
        // zt_Q is the first logical query head in this tile. Wrapping through
        // ne32 preserves the old shared-mask behavior and also enables a dense
        // per-head additive bias mask.
        const half   * mask_h = mask ?
            (const half *) (mask + nb33*(sequence % ne33) + nb32*(zt_Q % ne32)) :
            nullptr;
