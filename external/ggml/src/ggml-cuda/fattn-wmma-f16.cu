...
static __global__ void flash_attn_ext_f16(
    ...
    // The WMMA kernels follow the same broadcast rule as the other CUDA paths:
    // shared masks use ne32 == 1, while dense additive bias masks use ne32 to
    // carry a per-head slice.
