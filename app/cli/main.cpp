...
void print_task_list_help() {
    std::cout
        ...
        << "    --chunk-frames <n>  Codec frames per streaming PCM event (Qwen3-TTS default 2)\n"
        << "    --decoder-context-frames <n>  Streaming decoder left context (Qwen3-TTS default 25)\n"
        << "    --speaker-embedding-only true|false  Skip ICL codec prompting for Qwen3-TTS clone\n"
        << "    --stream-accumulate true|false  Retain final streaming waveform for --out\n"
        << "  Inputs:\n"
        ...
        << "    --text <text>\n"
        << "    --text-file <path>  Read one synthesis request from a text file\n"
