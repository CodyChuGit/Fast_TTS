...
const english: Record<string, string> = {
  ...
  'result.live': 'LIVE',
  'result.livePlayback': 'Incoming PCM audio is playing now.',
  ...
  'status.waitingForStream': 'Generating; waiting for the first audio chunk...',
  'status.livePlayback': 'Playing audio live while generation continues...',
  'status.finishingStream': 'Generation finished; playing the remaining buffered audio...',
